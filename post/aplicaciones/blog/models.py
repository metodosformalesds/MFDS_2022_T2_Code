...
class Post(ModeloBase):
    ...
    namePet = models.CharField('Nombre de la mascota ',max_length = 100)
    agePet = models.PositiveIntegerField(default=0)
    sizePet =  models.CharField('tamaño de la mascota ',max_length = 100)
    photoPet = models.ImageField('Imagen Mascota', upload_to='imagenes/', max_length=255)
